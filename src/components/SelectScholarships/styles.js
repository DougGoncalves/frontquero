...
button.add {
  padding: 20px ;
  background: ${props => (props.disabled ? Colors.LightGray : Colors.MainYellow)};
  margin-right: 10px;
  color: ${props => (props.disabled ? 'grey' : Colors.Black)};
  border: 1px solid
    ${props => (props.disabled ? Colors.LightGray : Colors.SecondaryYellow)};

  &:hover {
    color: ${props => (props.disabled ? 'grey' : '#FFFFFF')};
    background: ${props =>
      props.disabled ? Colors.LightGray : Colors.SecondaryBlue};
  }
}
